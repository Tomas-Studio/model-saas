...
<template>
  <div>
    <div v-if="showInput" class="motion-translate-x-in-[0%] motion-translate-y-in-[50%] motion-duration-[1s]/translate">
      <Form.Root :validation-schema="formSchema" class="w-[20rem]">
